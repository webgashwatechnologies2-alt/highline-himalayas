...
function BookingForm() {
  ...
  return (
    <div className="lg:sticky lg:top-24 rounded-3xl overflow-hidden shadow-[0_8px_48px_rgba(67,56,202,0.18)] border border-[#FF8C00]/15">
      {/* Header */}
...
function PackageCard({
  ...
  return (
    <article className="group relative isolate flex flex-col sm:flex-row bg-white rounded-3xl border border-slate-100/80 shadow-[0_2px_20px_rgba(15,23,42,0.06)] sm:hover:shadow-[0_16px_48px_rgba(15,23,42,0.14)] sm:hover:-translate-y-1 transition-all duration-300 overflow-hidden max-w-full">      {/* Image */}
      ...
      <div className="flex flex-1 flex-col sm:flex-row min-w-0">
        <div className="flex-1 px-4 sm:px-5 py-3.5 sm:py-4 min-w-0">
          ...
          <h3 className="text-[17px] sm:text-[20px] font-black leading-tight text-slate-900 group-hover:text-[#FF8C00] transition-colors duration-200 mb-1.5 line-clamp-2 sm:line-clamp-1">
            {pkg.title}
          </h3>
          <div className="flex items-center gap-1.5 mt-2 sm:mt-3">
            <div className="inline-flex max-w-full items-center gap-1 text-[#FF8C00] bg-indigo-50 rounded-full px-2.5 py-1.5 sm:py-2 text-[10px] font-bold">
        ...
        {/* Right Panel */}
        <div className="flex flex-col sm:flex-col justify-between sm:justify-center gap-2.5 px-4 py-3 sm:px-4 sm:py-4 sm:w-[165px] border-t sm:border-t-0 sm:border-l border-slate-100 bg-gradient-to-br from-slate-50 to-indigo-50/30 shrink-0">
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-col gap-2 w-full sm:mt-1">
            <Link
              ...
              className="flex items-center justify-center gap-1 h-9 rounded-xl bg-gradient-to-r from-[#FF8C00] to-[#F59E0B] text-white text-[10px] sm:text-[11px] font-black shadow-md shadow-indigo-200 hover:shadow-lg hover:scale-[1.03] active:scale-95 transition-all w-full text-center"
            >
            ...
            <button
              ...
              className="flex items-center justify-center gap-1 h-9 rounded-xl border-2 border-[#FF8C00]/60 text-[#FF8C00] text-[10px] sm:text-[11px] font-black hover:bg-[#FF8C00] hover:text-white hover:border-[#FF8C00] transition-all w-full cursor-pointer"
            >
...
function StatCard({ value, label, icon }: { value: string; label: string; icon: ReactNode }) {
  return (
    <div className="flex flex-col items-center gap-1 px-2 sm:px-6 py-3.5 sm:py-4">
      <div className="text-[#FF8C00] mb-0.5 sm:mb-1">{icon}</div>
    ...
    <div className="w-full bg-[#F8FAFC] min-h-screen overflow-x-hidden">
      ...
      <section className="relative isolate w-full min-h-[420px] sm:min-h-[540px] overflow-hidden">
        ...
        <div className="mx-auto flex min-h-[420px] sm:min-h-[540px] max-w-[1400px] items-center justify-center px-4 pt-16 pb-24 sm:py-20 sm:px-6 lg:px-10">          <div className="w-full max-w-[860px] text-center">
          ...
          {/* H1 */}
          <h1 className="text-[28px] sm:text-5xl md:text-[58px] font-black leading-tight sm:leading-[1.0] tracking-[-0.02em] sm:tracking-[-0.03em] text-white mb-4 sm:mb-5 px-1">            Spiti Valley{" "}

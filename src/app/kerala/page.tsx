...
function BookingForm() {
  ...
  return (
    <div className="lg:sticky lg:top-24 rounded-3xl overflow-hidden shadow-[0_8px_48px_rgba(22,101,52,0.18)] border border-[#166534]/15">
    ...
    <article className="group relative isolate flex flex-col sm:flex-row bg-white rounded-3xl border border-slate-100/80 shadow-[0_2px_20px_rgba(15,23,42,0.06)] sm:hover:shadow-[0_16px_48px_rgba(15,23,42,0.14)] sm:hover:-translate-y-1 transition-all duration-300 overflow-hidden max-w-full">      <div className="relative w-full sm:w-[210px] md:w-[230px] shrink-0 h-[200px] sm:min-h-[260px] sm:h-auto sm:self-stretch overflow-hidden bg-slate-100">
      ...
      <div className="flex flex-1 flex-col sm:flex-row min-w-0">
        <div className="flex-1 px-4 sm:px-5 py-3.5 sm:py-4 min-w-0">
          ...
          <h3 className="text-[17px] sm:text-[20px] font-black leading-tight text-slate-900 group-hover:text-[#166534] transition-colors duration-200 mb-1.5 line-clamp-2 sm:line-clamp-1">{pkg.title}</h3>
          <div className="flex items-center gap-1.5 mt-2 sm:mt-3">
            <div className="inline-flex max-w-full items-center gap-1 text-[#166534] bg-green-50 rounded-full px-2.5 py-1.5 sm:py-2 text-[10px] font-bold">
        ...
        <div className="flex flex-col sm:flex-col justify-between sm:justify-center gap-2.5 px-4 py-3 sm:px-4 sm:py-4 sm:w-[165px] border-t sm:border-t-0 sm:border-l border-slate-100 bg-gradient-to-br from-slate-50 to-green-50/30 shrink-0">
          ...
          <div className="grid grid-cols-2 sm:flex sm:flex-col gap-2 w-full sm:mt-1">
            <Link href={`/packages/${pkg.id}`}
              className="flex items-center justify-center gap-1 h-9 rounded-xl bg-gradient-to-r from-[#FF8C00] to-[#FF8C00] text-white text-[10px] sm:text-[11px] font-black shadow-md shadow-green-200 hover:shadow-lg hover:scale-[1.03] active:scale-95 transition-all w-full text-center">
              GET DETAILS <ArrowRight size={10} strokeWidth={3} />
            </Link>
            <button type="button"
              onClick={() => onEnquire(pkg)}
              className="flex items-center justify-center gap-1 h-9 rounded-xl border-2 border-[#166534]/60 text-[#166534] text-[10px] sm:text-[11px] font-black hover:bg-[#166534] hover:text-white hover:border-[#166534] transition-all w-full cursor-pointer">
...
function StatCard({ value, label, icon }: { value: string; label: string; icon: ReactNode }) {
  return (
    <div className="flex flex-col items-center gap-1 px-2 sm:px-6 py-3.5 sm:py-4">
      <div className="text-[#166534] mb-0.5 sm:mb-1">{icon}</div>
      ...
      <section className="relative isolate w-full min-h-[420px] sm:min-h-[540px] overflow-hidden">
        ...
        <div className="mx-auto flex min-h-[420px] sm:min-h-[540px] max-w-[1400px] items-center justify-center px-4 pt-16 pb-24 sm:py-20 sm:px-6 lg:px-10">          <div className="w-full max-w-[860px] text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-md border border-white/20 rounded-full px-3.5 sm:px-4 py-1.5 mb-4 sm:mb-5">
            ...
            <span className="text-white/90 text-[11px] sm:text-[12px] font-bold tracking-wider uppercase">God&apos;s Own Country</span>
          </div>
          <h1 className="text-[28px] sm:text-5xl md:text-[58px] font-black leading-tight sm:leading-[1.0] tracking-[-0.02em] sm:tracking-[-0.03em] text-white mb-4 sm:mb-5 px-1">            Kerala{" "}
